...
namespace ClipperLib
{
  ...
  using cInt = Int32;
    ...
    public class ClipperLib : ClipperBase
    {
...
#endif
        public ClipperLib(int InitOptions = 0) : base() //constructor
        {
            m_Scanbeam = null;
            m_Maxima = null;
            m_ActiveEdges = null;
    ...
    public class ClipperOffset
    {
        ...
        private void FixOrientations()
        {
            ...
            if (m_lowest.X >= 0 &&
              !ClipperLib.Orientation(m_polyNodes.Childs[(int)m_lowest.X].m_polygon))
            {
                for (int i = 0; i < m_polyNodes.ChildCount; i++)
                {
                    ...
                    if (node.m_endtype == EndType.etClosedPolygon ||
                      ...
                      ClipperLib.Orientation(node.m_polygon)))
        ...
        public void Execute(ref Paths solution, double delta)
        {
            ...
            ClipperLib clpr = new ClipperLib();
            ...
            {
                IntRect r = ClipperLib.GetBounds(m_destPolys);
